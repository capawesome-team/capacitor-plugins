...
- [`5f642068b30028f2deac88e964e0d922a0ea9af4`](https://github.com/capawesome-team/capacitor-plugins-sponsorware/commit/5f642068b30028f2deac88e964e0d922a0ea9af4) ([#346](https://github.com/capawesome-team/capacitor-plugins-sponsorware/pull/346)): fix(ios)!: use `Locale.preferredLanguages` instead of `Locale.current` as default value for the `language` option
...
- [`c7dcda038111222a6b88deea142d3b3f8099bcbc`](https://github.com/capawesome-team/capacitor-plugins-sponsorware/commit/c7dcda038111222a6b88deea142d3b3f8099bcbc) ([#329](https://github.com/capawesome-team/capacitor-plugins-sponsorware/pull/329)): feat!: automatically request necessary permissions on plugin call (see `BREAKING.md`)
