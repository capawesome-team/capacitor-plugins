...
public class MarkerDragStartEvent implements Result {
    ...
    public MarkerDragStartEvent(@NonNull LatLng coordinates, @NonNull String mapId, @NonNull String markerId) {
