...
📖 **Guide**: Building a navigation or wayfinding feature? See [The Complete Guide to Capacitor Device Sensors](https://capawesome.io/blog/capacitor-device-sensors-guide/) for how heading data fits into the bigger picture.
