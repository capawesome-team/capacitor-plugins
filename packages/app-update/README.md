...
> Check out the [Capacitor Live Update](https://capawesome.io/docs/plugins/live-update/) plugin to update your app remotely in real-time without submitting a new version to the app store. 🚀
