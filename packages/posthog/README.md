...
| **`webConfig`**                         | <code>Record&lt;string, any&gt;</code>                                | Additional [posthog-js configuration options](https://posthog.com/docs/libraries/js/config) that are merged into the configuration passed to `posthog.init`. Options set here take precedence over the other setup options. Only available on Web.                                           |                                         | 8.6.0 |
